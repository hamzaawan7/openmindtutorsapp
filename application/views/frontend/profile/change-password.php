    ...
    <section class="profile">
      <div class="row">
          ...
          <div class="menu-list margin-60-0">
            <ul>
              <li><a href="<?php echo ROUTE_PROFILE ?>">Personal information</a></li>
				<li class="active-menu"><h5><a href="<?php echo ROUTE_CHANGE_PASSWORD ?>" class="side-bar-active">Change Password</a></h5></li>
            </ul>
            <ul>
        ...
        <div class="col-md-8">
		  ...
		  <?php } ?>
          <div class="border-box activation-feeds margin-0-30">
